...
if(isset($_POST['name']))
{
    ...
    $r_type6 = $_POST['r_type6'];
    $att_nm6 = $_POST['att_nm6'];
    
    $course7 = $_POST['course7'];
    $r_type7 = $_POST['r_type7'];
    $att_nm7 = $_POST['att_nm7'];
    
    $course8 = $_POST['course8'];
    $r_type8 = $_POST['r_type8'];
    $att_nm8 = $_POST['att_nm8'];
    
    $tot_course = $_POST['tot_course'];
    $tot_credit = $_POST['tot_credit'];
    

    $sql = "INSERT INTO regtab (name,usn,year1,year2,sem type,dept,sem,sec,proc_usrnm,course1,r_type1,att_nm1,course2,r_type2,att_nm2,course3,r_type3,att_nm3,course4,r_type4,att_nm4,course5,r_type5,att_nm5,course6,r_type6,att_nm6,course7,r_type7,att_nm7,course8,r_type8,att_nm8,tot_course,tot_credit) VALUES ('$name','$usn','$year1','$year2','$semtype','$dept','$sem','$sec','$proc_usrnm','$course1','$r_type1','$att_nm1','$course2','$r_type2','$att_nm2','$course3','$r_type3','$att_nm3','$course4','$r_type4','$att_nm4','$course5','$r_type5','$att_nm5','$course6','$r_type6','$att_nm6','$course7','$r_type7','$att_nm7','$course8','$r_type8','$att_nm8','$tot_course','$tot_credit')";
...
<table>
                    ...
                    <tr>
                        ...
                        <td><select id="sel_title6" name ="course6" onchange="remove_dup(this)">
                                <option value="0">- Select Title -</option>
                                <?php 
                                // Fetch Course
                                $sql_course = "SELECT * FROM course";
                        ...
                        <td><select id="sel_code6">
                            <option value="0">- Select Code -</option>
                        </select></td>
                        <td><select name="r_type6" id = "rrty1" />
                            <option value="-1">Select Registration Type</option>
                            <option value="1">Regular</option>
                            <option value="2">Re-register</option>
                            <option value="NA">NA</option>
                        </td>
                        <td><select name="att_nm6" id = "atmt1" />
                        <option value="-1">Select Attempt</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                    ...
                    <tr>
                        ...
                        <td><select id="sel_title7" name ="course7" onchange="remove_dup(this)">
                                <option value="0">- Select Title -</option>
                                <?php 
                                // Fetch Course
                                $sql_course = "SELECT * FROM course";
                        ...
                        <td><select id="sel_code7">
                            <option value="0">- Select Code -</option>
                        </select></td>
                        <td><select name="r_type7" id = "rrty1" />
                            <option value="-1">Select Registration Type</option>
                            <option value="1">Regular</option>
                            <option value="2">Re-register</option>
                            <option value="NA">NA</option>
                        ...
                        <td><select name="att_nm7" id = "atmt1" />
                        <option value="-1">Select Attempt</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                    ...
                    <tr>
                        ...
                        <td><select id="sel_title8" name ="course8" onchange="remove_dup(this)">
                                <option value="0">- Select Title -</option>
                                <?php 
                                // Fetch Course
                                $sql_course = "SELECT * FROM course";
                        ...
                        <td><select id="sel_code8">
                            <option value="0">- Select Code -</option>
                        </select></td>
                        <td><select name="r_type8" id = "rrty1" />
                            <option value="-1">Select Registration Type</option>
                            <option value="1">Regular</option>
                            <option value="2">Re-register</option>
                            <option value="NA">NA</option>
                        </td>
                        <td><select name="att_nm8" id = "atmt1" />
                        <option value="-1">Select Attempt</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        for( var i = 0; i<len; i++){
                            ...
                            $("#sel_code6").append("<option value='"+id+"'>"+code+"</option>");
                        ...
                        for( var i = 0; i<len; i++){
                            ...
                            $("#sel_cred6").append("<option value='"+id+"'>"+cred+"</option>");
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        for( var i = 0; i<len; i++){
                            ...
                            $("#sel_code7").append("<option value='"+id+"'>"+code+"</option>");
                        ...
                        for( var i = 0; i<len; i++){
                            ...
                            $("#sel_cred7").append("<option value='"+id+"'>"+cred+"</option>");
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        for( var i = 0; i<len; i++){
                            ...
                            $("#sel_code8").append("<option value='"+id+"'>"+code+"</option>");
                        ...
                        for( var i = 0; i<len; i++){
                            ...
                            $("#sel_cred8").append("<option value='"+id+"'>"+cred+"</option>");
